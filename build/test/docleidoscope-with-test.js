...
(function() {
  ...
  tudor.add([
    ...
    }, "`config.delay` errors", "`config.delay` missing", "Server: `config.delay` must be type 'number'", function() {
      return new Server({
        env: 'server',
        dir: 'is/a/dir',
        fs: {
    ...
    }, "`config.delay` wrong type", "Server: `config.delay` must be type 'number'", function() {
      return new Server({
        env: 'server',
        dir: 'is/a/dir',
        delay: '1000',
    ...
    }, "`config.delay` too small", "Server: `config.delay` must be 100-3600000", function() {
      return new Server({
        env: 'server',
        dir: 'is/a/dir',
        delay: 99.99,
    ...
    }, "`config.delay` too big", "Server: `config.delay` must be 100-3600000", function() {
      return new Server({
        env: 'server',
        dir: 'is/a/dir',
